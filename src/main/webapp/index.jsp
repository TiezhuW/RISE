...
<body>
    ...
    <script>
        ...
        function domainSelectChange() {
            ...
            let domainBeijing = ["东城","西城","朝阳","海淀","丰台","通州","昌平","大兴","顺义","房山","平谷","怀柔","密云","延庆","石景山","门头沟","亦庄开发"];
            let domainShanghai = ["徐汇","闵行","静安","松江","黄浦","宝山","长宁","青浦","虹口","杨浦","普陀","金山","嘉定","崇明","奉贤","浦东","闸北","卢湾"];
            let domainGuangzhou = ["海珠","白云","番禺","黄埔","天河","越秀","从化","增城","花都","南沙"];
            let domainShenzhen = ["南山","福田","罗湖","宝安","龙岗","龙华","盐田","光明","坪山","布吉","大鹏新"];
            let domainHangzhou = ["西湖","下城","江干","拱墅","上城","下沙","滨江","余杭","萧山","富阳","临安","桐庐","淳安","建德","钱塘新"];
            let domainNanjing = ["鼓楼","建邺","秦淮","玄武","栖霞","江宁","浦口","六合","溧水","高淳","白下","下关","雨花台","滨江开发"];
            let domainSuzhou = ["姑苏","吴中","相城","吴江","常熟","昆山","太仓","金阊","沧浪","平江","虎丘","高新","张家港","工业园"];
            let domainWuxi = ["滨湖","梁溪","锡山","新吴","惠山","宜兴","江阴"];
            let domainTianjin = ["和平","南开","河东","河西","河北","红桥","西青","北辰","东丽","津南","塘沽","武清","宝坻","蓟州","静海","大港","汉沽","宁河","开发","滨海新","海河教育园"];
            ...
            let domainChengdu =["锦江","青羊","武侯","高新","成华","金牛","双流","温江","郫都","彭州","简阳","邛崃","大邑","蒲江","新津","龙泉驿","新都","金堂","崇州","天府新","青白江","都江堰"];
            let domainWuhan = ["江夏","江岸","江汉","硚口","武昌","洪山","汉阳","青山","汉南","蔡甸","黄陂","新洲","东西湖","东湖高新","沌口开发"];
            let domainXian = ["碑林","莲湖","未央","雁塔","高新","经开","新城","长安","灞桥","高陵","浐灞","临潼","鄠邑","周至","蓝田","阎良","大兴新","西咸新","曲江新"];
            function plus(value) {
